This is Tech Coolz's Discord Nuke V3, make sure to subscribe for more!
...
- !alert defaults = '@everyone', 10
	...
	EXAMPLE:
!alert "Make sure to subscribe to Tech Coolz"12 (spams the message "Make sure to subscribe to Tech Coolz"for 12 seconds)
